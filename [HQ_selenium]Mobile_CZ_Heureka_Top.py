...
d1 = {
    ...
    'Site' : "Heureka",
    'Product' : "Mobile",
    'Page' : "https://mobilni-telefony.heureka.cz",
    'Type' : "TOP",
    'Currency' : "CZK",
    #'Path' : ,  
    'Path' : "D:/Data_Analytics/WebScrapper/Result/",
    #'Path' : sys.argv[2],
    'Name_Class' : "product-container",
    'Rank_Class' : "foto",
    'Price_Class' : "price"
    }
...
try:
    ...
    product_rank = get_data(d1['Rank_Class'])
    product_price = get_data(d1['Price_Class'])
    
    d2 = {'Rank':product_rank, 'Name':product_name, 'Price':product_price}
    ...
    df['Rank'] = df['Rank'].str.replace('Top','').str.replace('.','')
